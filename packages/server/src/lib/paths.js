...
export const RENDER_SCRIPT_PATH = path.join(REPO_ROOT, "packages", "extract-pdfs", "render_pdf_pages.py");
...
export const FLOW_CHART_PICS_ROOT = path.join(UPLOADS_ROOT, "flow-chart");
